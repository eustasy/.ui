/**
 * nav-indicator.js — Animated coloured tab that slides between nav items.
 *
 * Usage:
 *   Add  data-nav-indicator="vertical"   to sidebar-style <ul> navs.
 *   Add  data-nav-indicator="horizontal" to stacked-style <ul> navs.
 *
